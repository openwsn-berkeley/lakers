...
typedef struct EdhocResponderC {
  State state;
  const uint8_t *r;
  uintptr_t r_len;
  const uint8_t *g_i;
...
struct EdhocResponderC responder_new(const uint8_t *r,
                                     uintptr_t r_len,
                                     const uint8_t *g_i,
                                     uintptr_t g_i_len,
                                     const uint8_t *id_cred_i,
...
struct EdhocInitiatorC initiator_new(const uint8_t *i,
                                     uintptr_t i_len,
                                     const uint8_t *g_r,
                                     uintptr_t g_r_len,
                                     const uint8_t *id_cred_i,
...
int8_t responder_process_message_1(struct EdhocResponderC *responder_c,
                                   const EdhocMessageBuffer *message_1);

int8_t responder_prepare_message_2(struct EdhocResponderC *responder_c,
                                   EdhocMessageBuffer *message_2,
                                   uint8_t *c_r);

int8_t initiator_process_message_2(struct EdhocInitiatorC *initiator_c,
                                   const EdhocMessageBuffer *message_2,
                                   uint8_t *c_r);

int8_t initiator_prepare_message_3(struct EdhocInitiatorC *initiator_c,
                                   EdhocMessageBuffer *message_3,
                                   uint8_t (*prk_out)[SHA256_DIGEST_LEN]);

int8_t responder_process_message_3(struct EdhocResponderC *responder_c,
