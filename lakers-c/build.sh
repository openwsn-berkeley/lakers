...
# cargo build --target=thumbv7em-none-eabihf -p lakers-c --no-default-features --features="crypto-cryptocell310, ead-authz" --release
# cargo build --target=thumbv7em-none-eabihf -p lakers-c --no-default-features --features="crypto-psa-baremetal, ead-authz" --release
...
cbindgen --config ./cbindgen.toml --crate lakers-c --output ../target/include/lakers_ffi.h -v
