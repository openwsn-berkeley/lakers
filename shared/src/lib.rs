...
// This needs to match BufferCiphertext2 as those are interchangible in a decrypt_encrypt function
pub type BufferPlaintext2 = EdhocBuffer<{ MAX_MESSAGE_SIZE_LEN + 20 }>;
pub type BufferPlaintext3 = EdhocBuffer<{ MAX_MESSAGE_SIZE_LEN + 2 }>;
pub type BufferPlaintext4 = EdhocBuffer<{ MAX_MESSAGE_SIZE_LEN + 3 }>;
pub type BytesMac2 = [u8; MAC_LENGTH_2];
pub type BytesMac3 = [u8; MAC_LENGTH_3];
pub type BufferMessage1 = EdhocBuffer<{ MAX_MESSAGE_SIZE_LEN + 4 }>;
pub type BufferMessage3 = EdhocBuffer<{ MAX_MESSAGE_SIZE_LEN + 5 }>;
pub type BufferMessage4 = EdhocBuffer<{ MAX_MESSAGE_SIZE_LEN + 6 }>;
pub type BufferCiphertext2 = EdhocBuffer<{ MAX_MESSAGE_SIZE_LEN + 20 }>;
pub type BufferCiphertext3 = EdhocBuffer<{ MAX_MESSAGE_SIZE_LEN + 8 }>;
pub type BufferCiphertext4 = EdhocBuffer<{ MAX_MESSAGE_SIZE_LEN + 9 }>;
pub type BytesHashLen = [u8; SHA256_DIGEST_LEN];
pub type BytesP256ElemLen = [u8; P256_ELEM_LEN];
pub type BufferMessage2 = EdhocBuffer<{ MAX_MESSAGE_SIZE_LEN + 10 }>;
