...
import cbor2
import pytest
from lakers import CredentialTransfer, EdhocInitiator, EdhocResponder, EADItem, EadItems
...
def test_initiator():
    ...
    message_1 = initiator.prepare_message_1(c_i=None, ead_1=EadItems())
...
def _test_handshake(cred_r_transfer, cred_i_transfer):
    ...
    message_3, i_prk_out = initiator.prepare_message_3(cred_i_transfer, EadItems())
    ...
    message_4 = responder.prepare_message_4(EadItems())
...
def test_state_missing_step():
    ...
    with pytest.raises(RuntimeError) as err:
        initiator.prepare_message_3(CredentialTransfer.ByReference, EadItems())
