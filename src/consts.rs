...
pub const ID_CRED_R: BytesIdCred = BytesIdCred(secret_bytes!([0xA1u8, 0x04u8, 0x41u8, 0x0Au8]));

pub const CRED_R: Bytes84 = Bytes84(secret_bytes!([
    0xA2u8, 0x02u8, 0x60u8, 0x08u8, 0xA1u8, 0x01u8, 0xA5u8, 0x01u8, 0x02u8, 0x02u8, 0x41u8, 0x0Au8,
    0x20u8, 0x01u8, 0x21u8, 0x58u8, 0x20u8, 0xBBu8, 0xC3u8, 0x49u8, 0x60u8, 0x52u8, 0x6Eu8, 0xA4u8,
    0xD3u8, 0x2Eu8, 0x94u8, 0x0Cu8, 0xADu8, 0x2Au8, 0x23u8, 0x41u8, 0x48u8, 0xDDu8, 0xC2u8, 0x17u8,
    0x91u8, 0xA1u8, 0x2Au8, 0xFBu8, 0xCBu8, 0xACu8, 0x93u8, 0x62u8, 0x20u8, 0x46u8, 0xDDu8, 0x44u8,
    0xF0u8, 0x22u8, 0x58u8, 0x20u8, 0x45u8, 0x19u8, 0xE2u8, 0x57u8, 0x23u8, 0x6Bu8, 0x2Au8, 0x0Cu8,
    0xE2u8, 0x02u8, 0x3Fu8, 0x09u8, 0x31u8, 0xF1u8, 0xF3u8, 0x86u8, 0xCAu8, 0x7Au8, 0xFDu8, 0xA6u8,
    0x4Fu8, 0xCDu8, 0xE0u8, 0x10u8, 0x8Cu8, 0x22u8, 0x4Cu8, 0x51u8, 0xEAu8, 0xBFu8, 0x60u8, 0x72u8
]));
