...
pub fn decode_plaintext_2(plaintext_2: &BytesPlaintext2) -> (U8, BytesMac2, BytesEad2) {
...
pub fn compute_prk_2e(x: &BytesP256ElemLen, g_y: &BytesP256ElemLen) -> BytesP256ElemLen {
